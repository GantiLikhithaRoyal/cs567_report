...
class sut(object):
    def act0(self):
        ...
        '''
        self.__test.append(('''import music_library ''',self.guard0,self.act0))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''import music_library '''))
    ...
    def act1(self):
        ...
        '''
        self.__test.append(('''ACTION("new_library", "library = music_library.MusicLibrary()") ''',self.guard1,self.act1))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION("new_library", "library = music_library.MusicLibrary()") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act2(self):
        ...
        '''
        self.__test.append(('''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") ''',self.guard2,self.act2))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act3(self):
        ...
        '''
        self.__test.append(('''ACTION("get_song_details", "song = library.get_song('Song A')") ''',self.guard3,self.act3))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION("get_song_details", "song = library.get_song('Song A')") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act4(self):
        ...
        '''
        self.__test.append(('''ASSERT(song['title'] == 'Song A') ''',self.guard4,self.act4))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ASSERT(song['title'] == 'Song A') '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act5(self):
        ...
        '''
        self.__test.append(('''ACTION("play_song", "library.play_song('Song A')") ''',self.guard5,self.act5))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION("play_song", "library.play_song('Song A')") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act6(self):
        ...
        '''
        self.__test.append(('''ASSERT(library.is_playing('Song A') == True) ''',self.guard6,self.act6))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ASSERT(library.is_playing('Song A') == True) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act7(self):
        ...
        '''
        self.__test.append(('''ACTION("pause_song", "library.pause_song('Song A')") ''',self.guard7,self.act7))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION("pause_song", "library.pause_song('Song A')") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act8(self):
        ...
        '''
        self.__test.append(('''ASSERT(library.is_playing('Song A') == False) ''',self.guard8,self.act8))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ASSERT(library.is_playing('Song A') == False) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act9(self):
        ...
        '''
        self.__test.append(('''ACTION("remove_song", "library.remove_song('Song A')") ''',self.guard9,self.act9))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION("remove_song", "library.remove_song('Song A')") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act10(self):
        ...
        '''
        self.__test.append(('''ASSERT(library.get_song('Song A') == None) ''',self.guard10,self.act10))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ASSERT(library.get_song('Song A') == None) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    # END INITIALIZATION CODE
        ...
        self.__actionClasses.append('''import music_library ''')
        self.__actionClasses.append('''ACTION("new_library", "library = music_library.MusicLibrary()") ''')
        self.__actionClasses.append('''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") ''')
        self.__actionClasses.append('''ACTION("get_song_details", "song = library.get_song('Song A')") ''')
        self.__actionClasses.append('''ASSERT(song['title'] == 'Song A') ''')
        self.__actionClasses.append('''ACTION("play_song", "library.play_song('Song A')") ''')
        self.__actionClasses.append('''ASSERT(library.is_playing('Song A') == True) ''')
        self.__actionClasses.append('''ACTION("pause_song", "library.pause_song('Song A')") ''')
        self.__actionClasses.append('''ASSERT(library.is_playing('Song A') == False) ''')
        self.__actionClasses.append('''ACTION("remove_song", "library.remove_song('Song A')") ''')
        self.__actionClasses.append('''ASSERT(library.get_song('Song A') == None) ''')
        self.__dependencies = {}
        self.__dependencies['''import music_library '''] = []
        self.__dependencies['''ACTION("new_library", "library = music_library.MusicLibrary()") '''] = []
        self.__dependencies['''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") '''] = []
        self.__dependencies['''ACTION("get_song_details", "song = library.get_song('Song A')") '''] = []
        self.__dependencies['''ASSERT(song['title'] == 'Song A') '''] = []
        self.__dependencies['''ACTION("play_song", "library.play_song('Song A')") '''] = []
        self.__dependencies['''ASSERT(library.is_playing('Song A') == True) '''] = []
        self.__dependencies['''ACTION("pause_song", "library.pause_song('Song A')") '''] = []
        self.__dependencies['''ASSERT(library.is_playing('Song A') == False) '''] = []
        self.__dependencies['''ACTION("remove_song", "library.remove_song('Song A')") '''] = []
        self.__dependencies['''ASSERT(library.get_song('Song A') == None) '''] = []
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        self.__refCode = {}
        ...
        self.__actions.append(('''import music_library ''',self.guard0,self.act0))
        self.__names['''import music_library '''] = ('''import music_library ''',self.guard0,self.act0)
        self.__actionClass['''import music_library '''] = '''import music_library '''
        self.__orderings['''import music_library '''] = 1
        self.__okExcepts['''import music_library '''] = ''''''
        
        self.__actions.append(('''ACTION("new_library", "library = music_library.MusicLibrary()") ''',self.guard1,self.act1))
        self.__names['''ACTION("new_library", "library = music_library.MusicLibrary()") '''] = ('''ACTION("new_library", "library = music_library.MusicLibrary()") ''',self.guard1,self.act1)
        self.__actionClass['''ACTION("new_library", "library = music_library.MusicLibrary()") '''] = '''ACTION("new_library", "library = music_library.MusicLibrary()") '''
        self.__orderings['''ACTION("new_library", "library = music_library.MusicLibrary()") '''] = 2
        self.__okExcepts['''ACTION("new_library", "library = music_library.MusicLibrary()") '''] = ''''''
        
        self.__actions.append(('''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") ''',self.guard2,self.act2))
        self.__names['''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") '''] = ('''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") ''',self.guard2,self.act2)
        self.__actionClass['''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") '''] = '''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") '''
        self.__orderings['''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") '''] = 3
        self.__okExcepts['''ACTION("add_song", "library.add_song('Song A', 'Artist A', 'Album A', 2023)") '''] = ''''''
        
        self.__actions.append(('''ACTION("get_song_details", "song = library.get_song('Song A')") ''',self.guard3,self.act3))
        self.__names['''ACTION("get_song_details", "song = library.get_song('Song A')") '''] = ('''ACTION("get_song_details", "song = library.get_song('Song A')") ''',self.guard3,self.act3)
        self.__actionClass['''ACTION("get_song_details", "song = library.get_song('Song A')") '''] = '''ACTION("get_song_details", "song = library.get_song('Song A')") '''
        self.__orderings['''ACTION("get_song_details", "song = library.get_song('Song A')") '''] = 4
        self.__okExcepts['''ACTION("get_song_details", "song = library.get_song('Song A')") '''] = ''''''
        
        self.__actions.append(('''ASSERT(song['title'] == 'Song A') ''',self.guard4,self.act4))
        self.__names['''ASSERT(song['title'] == 'Song A') '''] = ('''ASSERT(song['title'] == 'Song A') ''',self.guard4,self.act4)
        self.__actionClass['''ASSERT(song['title'] == 'Song A') '''] = '''ASSERT(song['title'] == 'Song A') '''
        self.__orderings['''ASSERT(song['title'] == 'Song A') '''] = 5
        self.__okExcepts['''ASSERT(song['title'] == 'Song A') '''] = ''''''
        
        self.__actions.append(('''ACTION("play_song", "library.play_song('Song A')") ''',self.guard5,self.act5))
        self.__names['''ACTION("play_song", "library.play_song('Song A')") '''] = ('''ACTION("play_song", "library.play_song('Song A')") ''',self.guard5,self.act5)
        self.__actionClass['''ACTION("play_song", "library.play_song('Song A')") '''] = '''ACTION("play_song", "library.play_song('Song A')") '''
        self.__orderings['''ACTION("play_song", "library.play_song('Song A')") '''] = 6
        self.__okExcepts['''ACTION("play_song", "library.play_song('Song A')") '''] = ''''''
        
        self.__actions.append(('''ASSERT(library.is_playing('Song A') == True) ''',self.guard6,self.act6))
        self.__names['''ASSERT(library.is_playing('Song A') == True) '''] = ('''ASSERT(library.is_playing('Song A') == True) ''',self.guard6,self.act6)
        self.__actionClass['''ASSERT(library.is_playing('Song A') == True) '''] = '''ASSERT(library.is_playing('Song A') == True) '''
        self.__orderings['''ASSERT(library.is_playing('Song A') == True) '''] = 7
        self.__okExcepts['''ASSERT(library.is_playing('Song A') == True) '''] = ''''''
        
        self.__actions.append(('''ACTION("pause_song", "library.pause_song('Song A')") ''',self.guard7,self.act7))
        self.__names['''ACTION("pause_song", "library.pause_song('Song A')") '''] = ('''ACTION("pause_song", "library.pause_song('Song A')") ''',self.guard7,self.act7)
        self.__actionClass['''ACTION("pause_song", "library.pause_song('Song A')") '''] = '''ACTION("pause_song", "library.pause_song('Song A')") '''
        self.__orderings['''ACTION("pause_song", "library.pause_song('Song A')") '''] = 8
        self.__okExcepts['''ACTION("pause_song", "library.pause_song('Song A')") '''] = ''''''
        
        self.__actions.append(('''ASSERT(library.is_playing('Song A') == False) ''',self.guard8,self.act8))
        self.__names['''ASSERT(library.is_playing('Song A') == False) '''] = ('''ASSERT(library.is_playing('Song A') == False) ''',self.guard8,self.act8)
        self.__actionClass['''ASSERT(library.is_playing('Song A') == False) '''] = '''ASSERT(library.is_playing('Song A') == False) '''
        self.__orderings['''ASSERT(library.is_playing('Song A') == False) '''] = 9
        self.__okExcepts['''ASSERT(library.is_playing('Song A') == False) '''] = ''''''
        
        self.__actions.append(('''ACTION("remove_song", "library.remove_song('Song A')") ''',self.guard9,self.act9))
        self.__names['''ACTION("remove_song", "library.remove_song('Song A')") '''] = ('''ACTION("remove_song", "library.remove_song('Song A')") ''',self.guard9,self.act9)
        self.__actionClass['''ACTION("remove_song", "library.remove_song('Song A')") '''] = '''ACTION("remove_song", "library.remove_song('Song A')") '''
        self.__orderings['''ACTION("remove_song", "library.remove_song('Song A')") '''] = 10
        self.__okExcepts['''ACTION("remove_song", "library.remove_song('Song A')") '''] = ''''''
        
        self.__actions.append(('''ASSERT(library.get_song('Song A') == None) ''',self.guard10,self.act10))
        self.__names['''ASSERT(library.get_song('Song A') == None) '''] = ('''ASSERT(library.get_song('Song A') == None) ''',self.guard10,self.act10)
        self.__actionClass['''ASSERT(library.get_song('Song A') == None) '''] = '''ASSERT(library.get_song('Song A') == None) '''
        self.__orderings['''ASSERT(library.get_song('Song A') == None) '''] = 11
        self.__okExcepts['''ASSERT(library.get_song('Song A') == None) '''] = ''''''
